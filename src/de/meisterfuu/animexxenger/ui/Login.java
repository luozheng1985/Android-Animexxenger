...
import de.meisterfuu.animexxenger.ui.wizard.AccountConfigure;
...
public class Login extends Activity {
	...
	if (app instanceof BeemApplication) {
		...
		startActivity(new Intent(this, AccountConfigure.class));
		finish();
	    }
	}
	...
	btlogin.setOnClickListener(new View.OnClickListener() {
		public void onClick(View v) {
			if (mBeemApplication.isAccountConfigured()) {
				    ...
				    Intent i = new Intent(c, LoginAnim.class);
	...
	try {
	    ...
	    PackageInfo pi = pm.getPackageInfo("de.meisterfuu.animexxenger", 0);
